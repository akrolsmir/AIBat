...
public class SettingsManager {
    private final static String SETTINGS_TXT_NAME = "settings.txt";
    private final static String SETTINGS_TXT_LOC = System
	    .getProperty("user.dir") + "\\" + SETTINGS_TXT_NAME;
    private final static String INDICATOR1 = "osu! Songs folder:";
    private final static String INDICATOR2 = "Bookmarks:";
	...
	BufferedReader f;
	try {
	    f = new BufferedReader(new FileReader(SETTINGS_TXT_LOC));
	}
	// If file is not found, create the file and try again
	catch (FileNotFoundException e) {
	    PrintWriter out = new PrintWriter(new BufferedWriter(
		    new FileWriter("settings.txt")));
	    out.print(toString());
	    out.close();
	    f = new BufferedReader(new FileReader(SETTINGS_TXT_LOC));
	...
	try {
	    PrintWriter out = new PrintWriter(new BufferedWriter(
		    new FileWriter(SETTINGS_TXT_LOC)));
	    out.print(toString());
	    out.close();
